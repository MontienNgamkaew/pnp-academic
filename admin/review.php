...
<main class="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="grid gap-8 md:grid-cols-3">
        ...
        <!-- Right: File Attachment Preview / Open link -->
        <div class="space-y-6">
            ...
            <div class="bg-white border border-slate-200 rounded-[32px] p-6 shadow-sm text-center">
                ...
                <?php if ($submission['file_path']): ?>
                    ...
                    <a href="../<?= e($submission['file_path']); ?>" target="_blank"
                       class="w-full inline-flex items-center justify-center gap-2 py-3 bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 text-xs font-bold rounded-xl transition">
                ...
                <?php if ($submission['drive_link']): ?>
                    ...
                    <a href="<?= e($submission['drive_link']); ?>" target="_blank"
                       class="w-full inline-flex items-center justify-center gap-2 py-3 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl transition shadow-md shadow-blue-600/10">
            ...
            <!-- PDF direct embed if PDF -->
            <?php if ($submission['file_path'] && strtolower(pathinfo($submission['file_path'], PATHINFO_EXTENSION)) === 'pdf'): ?>
                <div class="bg-white border border-slate-200 rounded-[32px] p-4 shadow-sm">
                    <span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest block text-center mb-3">ตัวอย่างเอกสารจำลอง (PDF Preview)</span>
                    <iframe src="../<?= e($submission['file_path']); ?>" class="w-full h-80 rounded-2xl border border-slate-200 bg-slate-100"></iframe>
                </div>
            <?php endif; ?>
